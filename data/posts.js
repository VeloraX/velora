...
export const posts = [
  {
    slug: "3-reasons-why-sodium-ion-batteries-could-dethrone-lithium",
    frontMatter: {
  ...
  {
    slug: "agi-hype-fading-artificial-general-intelligence-analysisi-ai-winter",
    frontMatter: {
  ...
  {
    slug: "create-an-object-that-travels-speed-of-light-syndication",
    frontMatter: {
  ...
  {
    slug: "everything-wanted-know-metaverse-but-afraid-ask-syndication",
    frontMatter: {
  ...
  {
    slug: "gig-startups-want-you-to-believe-they-can-replace-your-job-dont-fall-for-it",
    frontMatter: {
      title:
  ...
  {
    slug: "green-steel-is-the-next-big-thing-in-materials-innovation",
    frontMatter: {
  ...
  {
    slug: "how-to-hire-bootcamp-developer-without-getting-burned",
    frontMatter: {
      title:
  ...
  {
    slug: "how-to-work-5-hour-days-syndication",
    frontMatter: {
  ...
  {
    slug: "why-developers-divided-over-wordpress",
    frontMatter: {
