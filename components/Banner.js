...
export default function HeroSection() {
  ...
  return (
    <section className="tw-bg-transparent tw-py-20">
      <div className="tw-container tw-mx-auto">
        <div className="tw-flex tw-flex-wrap tw-items-center">
          <div className="tw-w-full md:tw-w-1/2 lg:tw-w-1/2 xl:tw-w-1/2">
          ...
          <div className="tw-w-full md:tw-w-1/2 lg:tw-w-1/2 xl:tw-w-1/2 tw-drop-shadow-[0_35px_35px_rgba(0,0,0,0.60)]">
            <iframe
              width="900"
              height="506"
